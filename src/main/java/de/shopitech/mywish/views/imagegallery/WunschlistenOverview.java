...
@PageTitle("Shopitech-My-Wish Wunschlisten")
@Route(value = "wunschlisten", layout = MainLayout.class)
@RouteAlias(value = "", layout = MainLayout.class)
@RolesAllowed(value = "USER")
public class WunschlistenOverview extends Main implements HasComponents, HasStyle {

    private OrderedList imageContainer;

    public WunschlistenOverview() {
